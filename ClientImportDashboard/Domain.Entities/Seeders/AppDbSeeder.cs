...
public static class AppDbSeeder
{
    public static async Task SeedAsync(ApiDbContext context)
    {
        ...
        var album1 = new Album
        {
            ...
            CoverImageUrl = "https://placehold.co/400x400/1e293b/ffffff?text=Neon+Nights"
        };

        var album2 = new Album
        {
            Title = "Coastal Echoes",
            ArtistName = "The Blue Lines",
            ReleaseDate = new DateOnly(2024, 11, 8),
            CoverImageUrl = "https://placehold.co/400x400/0f766e/ffffff?text=Coastal+Echoes"
        };

        var album3 = new Album
        {
            Title = "Ritmo del Sol",
            ArtistName = "María Sol",
            ReleaseDate = new DateOnly(2026, 2, 20),
            CoverImageUrl = "https://placehold.co/400x400/b45309/ffffff?text=Ritmo+del+Sol"
        };
        ...
        var tracks = new List<Track>
        {
            ...
            {
                AlbumId = album1.Id,
                GenreId = genreByName["Electronic"].Id,
                TrackNumber = 2,
            ...
            {
                AlbumId = album2.Id,
                GenreId = genreByName["Rock"].Id,
                TrackNumber = 1,
                Title = "Waves Don't Wait",
                DurationSeconds = 231,
                IsActive = false
            },
            new()
